...
async def _fetch_subtask_with_attachments(subtask_id: str, db: AsyncSession) -> Subtask:
    result = await db.execute(
        select(Subtask)
...
async def create_subtask(
    ...
    db.add(subtask)
    await db.commit()
    return await _fetch_subtask_with_attachments(subtask.id, db)
...
async def update_subtask(
    ...
    await db.commit()
    return await _fetch_subtask_with_attachments(subtask_id, db)
